...
function groupByMultipleOfFive() {
    let nums = numbers.filter(num => num % 5 == 0);
    console.log(nums);
}

groupByMultipleOfFive();

numArray = numbers.filter((number) => {
